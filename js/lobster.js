...
function use_google_api_to_create_marker(complete_location, info_window){
    ...
    result.marker.addListener('click', function(){
        ...
        if (complete_location.foursquare_result.website.indexOf("is missing") >= 0){
            var no_web_info_content = ko.computed(function() {
            ...
            info_window.setContent(no_web_info_content());
        }else{
            var with_web_info_content = ko.computed(function() {
            ...
            info_window.setContent(with_web_info_content());
        }
